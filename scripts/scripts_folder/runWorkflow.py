#!/usr/bin/env python2
# Workflow run script auto-generated by command: '/usr/local/bin/configManta.py --bam 6S_st_dr_filtered.bam --referenceFasta primary_dedup_chr.fa --runDir 6S_st_dr_filtered_manta_run'
#
...
main(r"/vast/palmer/scratch/hoh/zl436/simu/tool/nextflow_sv/work/c8/fc532cabc48ca27cf0002d0b80d03d/6S_st_dr_filtered_manta_run/runWorkflow.py.config.pickle","manta",MantaWorkflow)
